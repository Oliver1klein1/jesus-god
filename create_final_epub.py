...
def create_epub():
    ...
    if os.path.exists("Framing_Jesus_Final.epub"):
        os.remove("Framing_Jesus_Final.epub")
    
    # Create EPUB file
    with zipfile.ZipFile("Framing_Jesus_Final.epub", 'w', zipfile.ZIP_DEFLATED) as epub:
    ...
    print("EPUB created successfully: Framing_Jesus_Final.epub")
    
    # Verify the structure
    print("\nVerifying EPUB structure...")
    with zipfile.ZipFile("Framing_Jesus_Final.epub", 'r') as epub:
        ...
        required_files = [
            ...
            "OEBPS/Images/framing-jesus-cover.jpg"
        ]
