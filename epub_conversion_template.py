#!/usr/bin/env python3
"""
EPUB Conversion Template Script
Copy this script to new book projects for consistent EPUB generation
"""
...
def main():
    ...
    # Files to process (in order) - CUSTOMIZE THIS FOR YOUR BOOK
    files_to_process = [
        "introduction.html",
